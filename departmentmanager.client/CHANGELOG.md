...
- Create Angular project with ng: `ng new departmentmanager.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`departmentmanager.client.esproj`).
